...
![2fa-github](https://gi.weiyan.tech/2025/08/2fa-github.png)
...
![authentication-google](https://gi.weiyan.tech/2025/08/authentication-google.png)
...
![authenticator-app-edit](https://gi.weiyan.tech/2025/08/authenticator-app-edit.png)

## 身份验证器

点击浏览器的 "身份验证器" 插件，点击扫描图标，扫描上一步 GitHub Authenticator app 页面中生成的二维码。     
![authenticator-cc-scan](https://gi.weiyan.tech/2025/08/authenticator-cc-scan.png)

扫描后会自动生成6位数代码。     
![github-2fa-authentication-number](https://gi.weiyan.tech/2025/08/github-2fa-authentication-number.png)

这就是在 GitHub 登录账号时需要输入的 Two-factor authentication。     
![github-two-factor-authentication](https://gi.weiyan.tech/2025/08/github-two-factor-authentication.png)

## 导出备份

点击浏览器的 "身份验证器" 插件，左上角设置图标 → 备份 → 下载备份文件，会得到一个 **authenticator.txt** 的文件。     
![authenticator-cc-download-backup](https://gi.weiyan.tech/2025/08/authenticator-cc-download-backup.png)
